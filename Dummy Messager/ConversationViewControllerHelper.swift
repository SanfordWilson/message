...
extension ConversationViewController {
    ...
    override func viewDidLoad() {
        ...
        setupInput()
        bottomConstraint = NSLayoutConstraint(item: messageInputView, attribute: .bottom,
    ...
    private func setupInput() {
        ...
        messageInputView.contentView.visuallyFormat(format: "H:|-20-[v0]-10-[v1(20)]-10-|",
          views: inputTextField, inputTextFieldSendButton)
        messageInputView.contentView.visuallyFormat(format: "V:|-5-[v0]-5-|", views: inputTextField)
        messageInputView.contentView.addConstraint(NSLayoutConstraint(
          item: inputTextFieldSendButton, attribute: .centerY, relatedBy: .equal,
          toItem: inputTextField, attribute: .centerY, multiplier: 1.0, constant: 0.0))
        messageInputView.contentView.addConstraint(NSLayoutConstraint(
          item: inputTextFieldSendButton, attribute: .height, relatedBy: .equal,
          toItem: inputTextFieldSendButton, attribute: .width, multiplier: 1.0, constant: 0.0))
    }
    ...
    func scrollToEnd(animated: Bool, plus: CGFloat = 0) {
        ...
        self.collectionView?.scrollToItem(at: IndexPath(
          item: (messagesFetchController.sections?[0].numberOfObjects)! - 1, section: 0),
